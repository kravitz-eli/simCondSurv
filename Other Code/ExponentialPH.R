#########################################################################################################
#########################################################################################################
##Title: Exponential (Proportional Hazards) Projection of Overall Survival in Support of RELAY Submission
...
model{
  ...
  ##Priors
  beta~dnorm(0,.001)
  nu <- 1 #turns weibull into exponential
  lambda~dgamma(.1,.1)
...
update(mod,10000)
out.mod<- coda.samples(mod,variable.names=c('lambda','nu','beta','P'),n.iter=1000)
